...
Quadrangle::Quadrangle(int a, int b, int c, int d, int A, int B, int C, int D)
	...
	try
	{
		if ((A + B + C + D) != 360) { throw MyExceptionQuadrangle(a,b,c,d,A,B,C,D, "Четырехугольник:", " не был создан. Причина: сумма углов не равна 360 ");
		} else {
	...
	catch (const MyExceptionQuadrangle& e)
	{
		std::cout<< e.what()<< "\n" ;
	}
	}
